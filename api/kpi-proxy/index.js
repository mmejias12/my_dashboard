...
const API_HOST = 'func-walmart-reporting-csharp-b5a0fecwazamcnby.westus3-01.azurewebsites.net';
const API_PATH = '/api/kpi-diario';
...
module.exports = async function (context, req) {
  ...
  var desde = (req.query && req.query.desde) ? req.query.desde : '';
  var hasta = (req.query && req.query.hasta) ? req.query.hasta : '';
  var query = '?desde=' + desde + '&hasta=' + hasta;
